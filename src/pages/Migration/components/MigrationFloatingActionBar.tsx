...
export default function MigrationFloatingActionBar({
  ...
  return (
    <>
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-2.5 bg-slate-100 rounded-xl text-slate-500 hover:bg-slate-200 transition-all cursor-pointer"
      ...
      {/* Mobile Layout (block on mobile, hidden on lg) */}
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <button
                type="button"
                onClick={onClearSelection}
                className="p-2.5 bg-slate-100 hover:bg-slate-200 rounded-xl text-slate-500 transition-all cursor-pointer"
              >
                <Trash2 className="w-4 h-4" />
              </button>
              <button
